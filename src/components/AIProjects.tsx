      ...
      <AnimatePresence>
        {selectedProject && (
          ...
          >
            ...
            className="glass-premium rounded-t-3xl sm:rounded-3xl w-full sm:max-w-3xl md:max-w-4xl lg:max-w-6xl max-h-[85vh] sm:max-h-[90vh] overflow-hidden border border-[var(--ai-primary)]/20 shadow-2xl modal-scroll"
